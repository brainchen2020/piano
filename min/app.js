...
(function() {
    ...
    c.RGBA_HSLA = c.RGB_HSL = function(a) {
        var d = a.R / 255, b = a.G / 255, c = a.B / 255, g = Math.min(d, b, c), f = Math.max(d, b, c), l = f - g, n, r = (f + g) / 2;
        if (0 === l)
            g = n = 0;
        else {
            var g = 0.5 > r ? l / (f + g) : l / (2 - f - g)
              ...
              , p = ((f - b) / 6 + l / 2) / l
              , l = ((f - c) / 6 + l / 2) / l;
            d === f ? n = l - p : b === f ? n = 1 / 3 + q - l : c === f && (n = 2 / 3 + p - q);
            0 > n && (n += 1);
            1 < n && (n -= 1)
        }
        return {
    ...
    c.RGBA_HSVA = c.RGB_HSV = function(a) {
        var d = a.R / 255, b = a.G / 255, c = a.B / 255, g = Math.min(d, b, c), f = Math.max(d, b, c), l = f - g, n;
        if (0 === l)
            g = n = 0;
        else {
            var g = l / f
    ...
    c.HSLA_RGBA = c.HSL_RGB = function(a) {
        var d = a.H / 360, b = a.S / 100, c = a.L / 100, g, f, l;
        0 === b ? c = b = d = c : (f = 0.5 > c ? c * (1 + b) : c + b - b * c,
        g = 2 * c - f,
        l = d + 1 / 3,
        0 > l && (l += 1),
        1 < l && (l -= 1),
        c = 1 > 6 * l ? g + 6 * (f - g) * l : 1 > 2 * l ? f : 2 > 3 * l ? g + 6 * (f - g) * (2 / 3 - l) : g,
        l = d,
        0 > l && (l += 1),
        1 < l && (l -= 1),
        b = 1 > 6 * l ? g + 6 * (f - g) * l : 1 > 2 * l ? f : 2 > 3 * l ? g + 6 * (f - g) * (2 / 3 - l) : g,
        l = d - 1 / 3,
        0 > l && (l += 1),
        1 < l && (l -= 1),
        d = 1 > 6 * l ? g + 6 * (f - g) * l : 1 > 2 * l ? f : 2 > 3 * l ? g + 6 * (f - g) * (2 / 3 - l) : g);
        return {
            R: 255 * c,
            G: 255 * b,
            B: 255 * d,
    ...
    c.HSVA_RGBA = c.HSV_RGB = function(a) {
        var d = a.H / 360, b = a.S / 100, c = a.V / 100, g, f, l;
        if (0 === b)
            ...
            l = Math.round(255 * c * (1 - b * D)),
            C = Math.round(255 * c * (1 - b * (1 - D))),
            c = Math.round(255 * c),
            Math.floor(d)) {
            case 0:
                g = c;
...
(function() {
    MIDI.loadPlugin = function(d) {
        ...
        MIDI.audioDetect(function(e) {
            var f = ""
              , f = a[d.api] ? d.api : a[window.location.hash.substr(1)] ? window.location.hash.substr(1) : window.webkitAudioContext || window.AudioContext ? "webaudio" : window.Audio ? "audiotag" : "flash";
            if (b[f]) {
    ...
    var b = {
      ...
      , e = function(a) {
        this.totalSize || (this.getResponseHeader("Content-Length-Raw") ? this.totalSize = parseInt(this.getResponseHeader("Content-Length-Raw")) : this.totalSize = a.total);
...
(function() {
    ...
    (function() {
        ...
        e.connect = function(d) {
            ...
            navigator.requestMIDIAccess().then(function(b) {
                ...
                d.api = window.AudioContext || window.webkitAudioContext ? "webaudio" : window.Audio ? "audiotag" : "flash";
                MIDI.loadPlugin(d)
            })
        }
    }
    ...
    (window.AudioContext || window.webkitAudioContext) && function() {
        var a = window.AudioContext || window.webkitAudioContext, c = MIDI.WebAudio = {
            api: "webaudio"
        }, e, d = {}, k = 127, m = {}, g = function(a, d, c, b, k) {
    ...
    (function() {
        ...
        a.noteOn = function(a, b, m, g) {
            if (MIDI.channels[a] && (b = MIDI.GeneralMIDI.byId[MIDI.channels[a].instrument].number + "" + c[b],
            e[b])) {
                if (g)
                    return window.setTimeout(function() {
                        e[b].play({
        ...
        a.connect = function(d, k) {
            ...
            soundManager.onload = function() {
                ...
                var s = window.setInterval(function() {
                    f.length < l || (window.clearInterval(s),
...
(function() {
    ...
    ;
    b.scaleInfo = function(a) {
        var b = "r b2 2 b3 3 4 b5 5 &#X266F;5 6 b7 7 8 b9 9 &#X266F;9 10 11 b12 12 &#X266F;12 13".split(" "), e = "", d = "", k = "", m = "", g = "", f;
        for (f in a) {
            0 < a[f] && (k += "-" + (a[f] - l));
            var l = a[f]
...
(function(b) {
    b.btoa || (b.btoa = function(a) {
        ...
        do
            ...
            g = (d & 15) << 2 | k >> 6,
            f = k & 63,
            isNaN(d) ? g = f = 64 : isNaN(k) && (f = 64),
            b = b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f);
        while (l < a.length);
        return b
    }
    );
    b.atob || (b.atob = function(a) {
        ...
        do
            ...
            m = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++)),
            g = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(f++)),
            e = e << 2 | d >> 4,
            d = (d & 15) << 4 | m >> 2,
            k = (m & 3) << 6 | g,
            b += String.fromCharCode(e),
            64 != m && (b += String.fromCharCode(d)),
...
(function() {
    DOM.dimensions = function() {
        document.body && (document.body.scrollHeight || (document.body.scrollHeight = Math.max(document.body.scrollHeight, document.documentElement.scrollHeight)),
        window.innerWidth && window.innerHeight || (document.body && document.body.offsetWidth ? (window.innerWidth = document.body.offsetWidth,
        window.innerHeight = document.body.offsetHeight) : "CSS1Compat" === document.compatMode && (document.documentElement && document.documentElement.offsetWidth) && (window.innerWidth = document.documentElement.offsetWidth,
...
(function() {
    ...
    function c(b, d) {
        ...
        case "object":
            ...
            if (f && "object" === typeof f)
                for (s = f.length,
                e = 0; e < s; e += 1)
                    "string" === typeof f[e] && (g = f[e],
                    (p = c(g, w)) && v.push(a(g) + (k ? ": " : ":") + p));
            else
                for (g in w)
    ...
    var e = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, d = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, k, m, g = {
        "\b": "\\b",
        "\t": "\\t",
        "\n": "\\n",
        "\f": "\\f",
    ...
    "function" !== typeof JSON.parse && (JSON.parse = function(a, b) {
        function d(a, c) {
            ...
            if (f && "object" === typeof f)
                for (e in f)
                    Object.prototype.hasOwnProperty.call(f, e) && (k = d(f, e),
                    void 0 !== k ? f[e] = k : delete f[e]);
            return b.call(a, c, f)
        }
        var c;
        a = String(a);
...
(function() {
    ...
    widgets.FileSaver = function(a) {
        ...
        this.button = function(a) {
            ...
            a.src ? (p = new Image,
            p.src = a.src,
            s.appendChild(p)) : s.innerHTML = a.title ? a.title : f + "." + l;
            q.appendChild(s);
            b.appendChild(q);
            setTimeout(function() {
                var p = b.offsetWidth
        ...
        var d = function(a) {
            function c(a, d) {
                var e = a.data
                  , f = {};
                -1 !== e.indexOf("base64") && (e = e.split(";"),
                b[e[0].substr(5)] && (f.binary = !1),
                f.base64 = !0,
                e = e[1].substr(7));
                d.add(a.name, e, f)
            }
...
(function() {
        ...
        if (!a) {
            ...
            if (k.container) {
                ...
                this.update = function(a, b, c) {
                    ...
                    "..." === b.substr(-3) ? (a._message = b.substr(0, b.length - 3),
                    a.messageAnimate = [".&nbsp;&nbsp;", "..&nbsp;", "..."].reverse()) : (a._message = b,
                    a.messageAnimate = !1);
                ...
                this.add = function(a) {
                    ...
                    k.background && (this.div.style.background = k.backgrond);
                ...
                this.remove = function(a) {
                    ...
                    for (var b in this.messages) {
                        ...
                        a && -1 === a.indexOf(":" + c.seed + ":") || (delete this.messages[c.seed],
                        c.container.style.color = "#99ff88",
                        v(c),
                        c.getProgress && (c.span.innerHTML = "100%"))
                    }
                }
                ;
                ...
                this.stop = function() {
                    ...
                    if (k.oncomplete)
                        k.oncomplete();
                    f && f.style && (l.style.cssText += "pointer-events: none;",
                    window.setTimeout(function() {
                        m.div.style.opacity = 0
                    }, 1),
                    window.setTimeout(function() {
                        m.interval || (m.stopPropagation = !1,
                ...
                var v = function(a) {
                  ...
                  , w = function() {
                    ...
                    for (c = 0; c < n; c++) {
                        ...
                        t.lineTo(d + g, 0 + f);
                        t.quadraticCurveTo(d, 0 + f, d, 0 + f - g);
                        t.lineTo(d, 0 + g);
    ...
    ;
    var e = function(a, b) {
        return "\t\t-webkit-transition-property: " + a + ";\t\t-webkit-transition-duration: " + b + "ms;\t\t-moz-transition-property: " + a + ";\t\t-moz-transition-duration: " + b + "ms;\t\t-o-transition-property: " + a + ";\t\t-o-transition-duration: " + b + "ms;\t\t-ms-transition-property: " + a + ";\t\t-ms-transition-duration: " + b + "ms;"
    }
      , d = function(a) {
        if (window.innerWidth && window.innerHeight)
            ...
            "CSS1Compat" === document.compatMode && document.documentElement && document.documentElement.offsetWidth ? (b = document.documentElement.offsetWidth,
            d = document.documentElement.offsetHeight) : document.body && document.body.offsetWidth && (b = document.body.offsetWidth,
...
widgets.Uploader = function(b) {
              ...
              , l = function(e) {
                ...
                f.onreadystatechange = function(b) {
                    if (4 === f.readyState && "success" === b.srcElement.responseText)
                        return a.fileCollection[d].uploaded = !0,
                        c()
                }
                ;
                "undefined" !== typeof f.sendAsBinary ? (f.open("POST", a.uploadPath + "?upload=true", !0),
                e = "--xxxxxxxxx\r\n" + ("Content-Disposition: form-data; name='upload'; filename='" + b.name + "'\r\n"),
                e = e + "Content-Type: application/octet-stream\r\n\r\n" + (n.result + "\r\n"),
                e += "--xxxxxxxxx\r\n",
                f.setRequestHeader("content-type", "multipart/form-data; boundary=xxxxxxxxx"),
                f.sendAsBinary(e)) : (f.open("POST", a.uploadPath + "?upload=true&base64=true", !0),
                f.setRequestHeader("X-FILENAME", b.name),
                f.setRequestHeader("X-FILESIZE", b.size),
                f.setRequestHeader("X-FILETYPE", b.type),
                f.send(window.btoa(n.result)))
            }
              , n = new FileReader;
            "undefined" !== typeof n.addEventListener ? (n.addEventListener("loadend", l, !1),
            n.addEventListener("error", e, !1),
            n.addEventListener("progress", f, !1)) : (n.onloadend = l,
            n.onerror = e,
            n.onprogress = f);
    ...
    this.handleFiles = function(b, d) {
        var e = 0
          , f = b.length;
        d || (d = {});
        0 < f && (a.singleFile && !0 !== d.upload) && (a.fileCollection = {});
        (c = function() {
            var l = b[e]
              , n = {
                status: a.status,
            ...
            if (++e > a.maxFiles || !l)
                ...
                if (!a.acceptedFormats[n])
                    return console.log(n + "is not an accepted format."),
                    c();
                if (0 === (l.fileSize || l.size))
    ...
    d.type = "file";
    d.name = "files[]";
    !this.singleFile && 1 < this.maxFiles && (d.multiple = "multiple");
    ...
    e.appendChild(d);
    b = function(a) {
        !window.innerWidth && (document.body && document.body.offsetWidth) && (window.innerWidth = document.body.offsetWidth,
        window.innerHeight = document.body.offsetHeight);
        window.innerWidth && window.innerHeight && (e.style.width = window.innerWidth + "px",
    ...
    var e = document.getElementsByTagName("head")[0]
      ...
      , m = function(c) {
        ...
        if (/([\w\d.])$/.test(c.verify))
            if (c.test = c.verify,
            "object" === typeof c.test)
                for (var f in c.test)
                    k.push(c.test[f]);
            else
                k.push(c.test);
        a.loaded[c.src] || (f = document.createElement("script"),
...
if ("undefined" === typeof (new XMLHttpRequest).responseText) {
    ...
    DOMLoader.sendRequest = function(b) {
        ...
        c.onreadystatechange = function(e) {
            if (4 === c.readyState && (200 === c.status ? c.responseText = a(c.responseBody) : c = !1,
            b.onload))
                b.onload(c)
        }
        ;
...
Event = function(b) {
    ...
    var a = function(b) {
            ...
            if ("string" === typeof g && "ready" === q)
                var w = (new Date).getTime()
                  ...
                  , B = window.setInterval(function() {
                    ...
                    document.querySelector(g) && (window.clearInterval(B),
                    setTimeout(p, 1))
                }, s.interval || 1E3 / 60);
            else {
                if ("string" === typeof g) {
      ...
      , k = function() {
        var a = {};
        return function(d) {
            b.pointerType || (window.navigator.msPointerEnabled ? (b.pointerType = "mspointer",
            a = {
                mousedown: "MSPointerDown",
                mousemove: "MSPointerMove",
                mouseup: "MSPointerUp"
            }) : b.supports("touchstart") ? (b.pointerType = "touch",
            a = {
    ...
    b.modifyEventListener && window.HTMLElement && function() {
        ...
        a(HTMLCanvasElement.prototype)) : a(HTMLElement.prototype);
        a(document);
        a(window)
    }();
    b.modifySelectors && function() {
...
Event.proxy = function(b) {
    b.pointerSetup = function(a, b) {
        ...
        ;
        b.pause = function(b) {
            !a.onPointerMove || b && !b.move || Event.remove(a.doc, d + "move", a.onPointerMove);
    ...
    b.pointerStart = function(a, c, e) {
        var d = function(a, b) {
            ...
            if ("relative" === e.position)
                var f = (a.pageX + d.scrollLeft - c.offsetX) * d.scaleX
    ...
    b.getCoords = function(a) {
        b.getCoords = "undefined" !== typeof a.pageX ? function(a) {
            return Array({
                type: "mouse",
                x: a.pageX,
                y: a.pageY,
    ...
    b.getBoundingBox = function(a) {
        ...
        a === document.body ? (b.height = window.innerHeight,
        b.width = window.innerWidth) : (b.height = a.offsetHeight,
...
Event.proxy = function(b) {
    b.click = function(a) {
        ...
        a.onPointerDown = function(d) {
            b.pointerStart(d, e, a) && (Event.add(a.doc, "mousemove", a.onPointerMove).listener(d),
        ...
        a.onPointerUp = function(d) {
            if (b.pointerEnd(d, e, a) && (Event.remove(a.doc, "mousemove", a.onPointerMove),
            Event.remove(a.doc, "mouseup", a.onPointerUp),
            !(c.cancelBubble && 1 < ++c.bubble))) {
                var k = (c.changedTouches || b.getCoords(c))[0];
                d = a.bbox;
                var m = b.getBoundingBox(a.target);
                if ("relative" === a.position)
                    var g = (k.pageX + d.scrollLeft - d.x1) * d.scaleX
...
Event.proxy = function(b) {
    b.dbltap = b.dblclick = function(a) {
        ...
        a.onPointerDown = function(f) {
            ...
            b.pointerStart(f, g, a) && (Event.add(a.doc, "mousemove", a.onPointerMove).listener(f),
            Event.add(a.doc, "mouseup", a.onPointerUp))
        }
        ;
        a.onPointerMove = function(f) {
            ...
            f = a.bbox;
            if ("relative" === a.position)
                var g = (m.pageX + f.scrollLeft - f.x1) * f.scaleX
                  , n = (m.pageY + f.scrollTop - f.y1) * f.scaleY;
            else
                g = m.pageX - f.x1,
                n = m.pageY - f.y1;
            0 < g && g < f.width && 0 < n && n < f.height && 25 >= Math.abs(m.pageX - k.pageX) && 25 >= Math.abs(m.pageY - k.pageY) || (Event.remove(a.doc, "mousemove", a.onPointerMove),
            clearTimeout(d),
            c = e = 0)
        }
        ;
        a.onPointerUp = function(f) {
            b.pointerEnd(f, g, a) && (Event.remove(a.doc, "mousemove", a.onPointerMove),
            Event.remove(a.doc, "mouseup", a.onPointerUp));
            c && e && (700 >= e && !(f.cancelBubble && 1 < ++f.bubble) && (g.state = a.gesture,
            a.listener(f, g)),
            clearTimeout(d),
            c = e = 0)
        }
...
Event.proxy = function(b) {
    ...
    b.drag = function(a) {
        ...
        a.onPointerDown = function(e) {
            b.pointerStart(e, c, a) && !a.monitor && (Event.add(a.doc, "mousemove", a.onPointerMove),
            Event.add(a.doc, "mouseup", a.onPointerUp));
        ...
        a.onPointerMove = function(e, d) {
            ...
            for (var k = a.bbox, m = e.changedTouches || b.getCoords(e), g = m.length, f = 0; f < g; f++) {
                var l = m[f]
                  , n = l.identifier || Infinity
                  , r = a.tracker[n];
                r && (r.pageX = l.pageX,
                ...
                c.start = r.start,
                c.fingers = a.fingers,
                "relative" === a.position ? (c.x = (r.pageX + k.scrollLeft - r.offsetX) * k.scaleX,
                c.y = (r.pageY + k.scrollTop - r.offsetY) * k.scaleY) : (c.x = r.pageX - r.offsetX,
                c.y = r.pageY - r.offsetY),
                a.listener(e, c))
            }
        }
        ;
...
Event.proxy = function(b) {
    ...
    b.gesture = function(c) {
        ...
        c.onPointerDown = function(a) {
            var k = c.fingers;
            b.pointerStart(a, e, c) && (Event.add(c.doc, "mousemove", c.onPointerMove),
            Event.add(c.doc, "mouseup", c.onPointerUp));
        ...
        c.onPointerMove = function(d, k) {
            for (var m = c.bbox, g = c.tracker, f = d.changedTouches || b.getCoords(d), l = f.length, n = 0; n < l; n++) {
                var r = f[n]
                  , q = r.identifier || Infinity
                  , p = g[q];
                p && ("relative" === c.position ? (p.move.x = (r.pageX + m.scrollLeft - m.x1) * m.scaleX,
                p.move.y = (r.pageY + m.scrollTop - m.y1) * m.scaleY) : (p.move.x = r.pageX - m.x1,
                p.move.y = r.pageY - m.y1))
            }
            if (!(c.fingers < c.minFingers)) {
                ...
                for (q in g)
                    ...
                    !r.up) {
                        ...
                        r.DEG2 = r.DEG1;
                        r.DEG1 = 0 < l ? l : -l;
                        "undefined" !== typeof r.DEG2 && (r.rotation = 0 < l ? r.rotation + (r.DEG1 - r.DEG2) : r.rotation - (r.DEG1 - r.DEG2),
                        n += r.rotation);
                        f.push(r.move)
                    }
                e.touches = f;
        ...
        c.onPointerUp = function(a) {
            var k = c.fingers;
            b.pointerEnd(a, e, c) && (Event.remove(c.doc, "mousemove", c.onPointerMove),
            Event.remove(c.doc, "mouseup", c.onPointerUp));
            k === c.minFingers && c.fingers < c.minFingers && (e.fingers = c.fingers,
            e.state = "end",
            c.listener(a, e))
        }
        ;
...
Event.proxy = function(b) {
    b.shake = function(a) {
            ...
            if ("devicemotion" === a.gesture)
                ...
                for (var f = (new Date).getTime(), l = 0; 3 > l; l++) {
                    var n = "xyz"[l]
                      ...
                      , q = Math.abs(m);
                    !(1E3 > f - e) && 4 < q && (m = f * m / q,
                    q = Math.abs(m + n.value),
                    n.value && 200 > q ? (n.value = m,
                    n.count++,
                    3 === n.count && (a.listener(g, b),
                    e = f,
                    n.value = 0,
                    n.count = 0)) : (n.value = m,
                    n.count = 1))
        ...
        if (window.addEventListener)
            return window.addEventListener("devicemotion", m, !1),
            b
    }
    ;
    Event.Gesture = Event.Gesture || {};
...
Event.proxy = function(b) {
    ...
    b.swipe = function(c) {
        ...
        c.onPointerDown = function(a) {
            b.pointerStart(a, e, c) && (Event.add(c.doc, "mousemove", c.onPointerMove).listener(a),
            Event.add(c.doc, "mouseup", c.onPointerUp))
        }
        ;
        c.onPointerMove = function(a) {
            ...
            for (var e = a.length, m = 0; m < e; m++) {
                ...
                f && (f.move.x = g.pageX,
                f.move.y = g.pageY,
                f.moveTime = (new Date).getTime())
            }
        }
        ;
        c.onPointerUp = function(d) {
            if (b.pointerEnd(d, e, c)) {
                ...
                e.x = n / q,
                e.y = r / q,
                e.angle = -(((g / c.snap + 0.5 >> 0) * c.snap || 360) - 360),
                e.velocity = k,
                e.fingers = c.gestureFingers,
                e.state = "swipe",
                c.listener(d, e))
            }
        }
...
Event.proxy = function(b) {
    b.tap = b.longpress = function(a) {
        ...
        a.onPointerDown = function(k) {
            b.pointerStart(k, d, a) && (c = (new Date).getTime(),
            Event.add(a.doc, "mousemove", a.onPointerMove).listener(k),
            Event.add(a.doc, "mouseup", a.onPointerUp),
            "longpress" === a.gesture && (e = setTimeout(function() {
        ...
        a.onPointerMove = function(d) {
            ...
            for (var e = d.length, f = 0; f < e; f++) {
                ...
                if (n) {
                    if ("relative" === a.position)
                        var r = (l.pageX + c.scrollLeft - c.x1) * c.scaleX
        ...
        a.onPointerUp = function(k) {
            b.pointerEnd(k, d, a) && (clearTimeout(e),
            Event.remove(a.doc, "mousemove", a.onPointerMove),
            Event.remove(a.doc, "mouseup", a.onPointerUp),
            k.cancelBubble && 1 < ++k.bubble || ("longpress" === a.gesture ? "start" === d.state && (d.state = "end",
            a.listener(k, d)) : a.cancel || (new Date).getTime() - c > a.timeout || (d.state = "tap",
            d.fingers = a.gestureFingers,
            a.listener(k, d))))
        }
        ;
...
Event.proxy = function(b) {
    b.wheel = function(a) {
        ...
        }, g = document.addEventListener ? "addEventListener" : "attachEvent", f = document.removeEventListener ? "removeEventListener" : "detachEvent", l = Event.supports("mousewheel") ? "mousewheel" : "DOMMouseScroll";
        a.target[g](l, m, !1);
        return k
    }
    ;
...
var clone = function(b) {
    if ("object" != typeof b || null == b)
        return b;
    var a = "number" == typeof b.length ? [] : {}, c;
    for (c in b)
        a[c] = clone(b[c]);
    return a
};
function Replayer(b, a, c, e) {
    function d() {
        for (var a = null, d = null, c = null, e = 0; e < k.length; e++)
            null != k[e].ticksToNextEvent && (null == a || k[e].ticksToNextEvent < a) && (a = k[e].ticksToNextEvent,
            d = e,
            c = k[e].nextEventIndex);
        if (null != d) {
            var f = b.tracks[d][c];
    ...
    (function() {
        if (l = d())
            for (; l; ) {
                ...
                var b = 0
                  , b = 0;
                0 < l.ticksToEvent && (b = l.ticksToEvent / f,
                b /= m / 60);
                n.push([l, 1E3 * b * a || 0]);
                l = d()
            }
    ...
    var l = function(a) {
        ...
        for (var b in a)
            if (a.hasOwnProperty(b))
                this["set" + b.charAt(0).toUpperCase() + b.substring(1)](a[b])
    };
...
window.localStorage || (window.localStorage = {
    ...
    setItem: function(b, a) {
        b && (document.cookie = escape(b) + "=" + escape(a) + "; path=/",
...
var Base64Binary = {
    ...
    decode: function(b, a) {
        ...
        64 == c && d--;
        64 == e && d--;
        var k, m, g, f, l = 0, n = 0, c = a ? new Uint8Array(a) : new Uint8Array(d);
        b = b.replace(/[^A-Za-z0-9\+\/\=]/g, "");
        for (l = 0; l < d; l += 3)
            k = this._keyStr.indexOf(b.charAt(n++)),
            m = this._keyStr.indexOf(b.charAt(n++)),
            e = this._keyStr.indexOf(b.charAt(n++)),
            f = this._keyStr.indexOf(b.charAt(n++)),
            k = k << 2 | m >> 4,
            m = (m & 15) << 4 | e >> 2,
            g = (e & 3) << 6 | f,
            c[l] = k,
...
var Util = {
    ...
    arrayBufferToBinaryString: function(b, a, c) {
        var e = new FileReader;
        e.onload = function(b) {
            a(b.target.result)
        }
...
var Filer = new function() {
    ...
    var a = null
      ...
      , m = function(b, d, c, e, m, q) {
        ...
        (b.isFile || d.isDirectory) && d.isDirectory ? s ? b.moveTo(d, p, e, m) : b.copyTo(d, p, e, m) : k(function(a, b) {
            if (b.isDirectory)
                s ? a.moveTo(b, p, e, m) : a.copyTo(b, p, e, m);
            else {
    ...
    b.prototype.init = function(b, d, k) {
        ...
        "persistent"in b && b.persistent && (this.type = self.PERSISTENT);
        var r = function(b) {
            this.size = m;
            a = b;
            c = a.root;
            ...
            var b = []
              ...
              , k = function() {
                g.readEntries(function(a) {
                    a.length ? (b = b.concat(Util.toArray(a)),
                    k()) : (b.sort(function(a, b) {
        ...
        var m = null != d ? d : !1
          ...
          , p = function(a, d) {
            ...
            a.getDirectory(d[0], {
                ...
                else if (a = Error(b + " is not a directory"),
                k)
                    k(a);
                else
                    throw a;
    ...
    b.prototype.create = function(b, d, e, k) {
        ...
        c.getFile(b, {
            ...
            a.code == FileError.INVALID_MODIFICATION_ERR && (a.message = "'" + b + "' already exists");
            if (k)
                k(a);
            else
                throw a;
    ...
    b.prototype.cd = function(b, e, l) {
        ...
        k(function(a) {
            if (a.isDirectory)
                c = a,
                e && e(c);
            else if (a = Error("Path was not a directory."),
            l)
                l(a);
            else
                throw a;
    ...
    b.prototype.df = function(a, b) {
        ...
        self.TEMPORARY == this.type ? navigator.temporaryStorage.queryUsageAndQuota(d, b) : self.PERSISTENT == this.type && navigator.persistentStorage.queryUsageAndQuota(d, b)
    }
    ;
    return b
}
...
(function(b) {
    ...
    Piano.MIDIPlayerPercentage = function() {
        ...
        Event.add(d, "drag", function(a, d) {
            ...
            "down" === d.state ? (isPlaying = b.playing,
            b.pause()) : "up" === d.state && isPlaying && Piano.resume();
    ...
    Piano.loadPlugin = function() {
        MIDI.loadPlugin(function() {
            ...
            if ("#http" === window.location.hash.substr(0, 5))
                ...
                else if (Piano.midifile = localStorage.midifile,
            ...
            "Java" == MIDI.lang && (MIDI.setVolume(Piano.channel, 100),
            Piano.drawInstruments());
            ...
            Piano.filesArray = [];
            for (d in Piano.files)
                d === Piano.midifile && (Piano.fileID = Piano.filesArray.length),
                Piano.filesArray.push(d)
        })
    }
    ;
    Piano.loadFile = function(a, e) {
        ...
        if (a)
            b.midifile = a,
            Piano.loadExternalMIDI(b.midifile, e, host + "/audio/");
    ...
    Piano.loadExternalMIDI = function(c, e, d) {
        ...
        document.getElementById("playback-title").innerHTML = f.replace(".midi", "").replace(".mid", "");
    ...
    var a = function() {
        ...
        "undefined" === typeof CanvasRender && (CanvasRender = {},
        ...
        Piano.debug && (CanvasRender[0].style.background = "rgba(0,0,255,0.25)",
...
var root = Piano.Animation = function() {
        ...
        if (Piano.notesPlaying || !(150 < c) || b)
            if ("preview" === Piano.visualize && d.replayer) {
                if (d.playing || b)
                    ...
                    d.renderScreen(!0),
                    e.tCurrent !== d.currentTime && (a = (new Date).getTime(),
                    ...
                    for (l in f)
                        if (f[l].isOn) {
                            ...
                            if (Piano.blackKeys[n % 12]) {
                                ...
                                r = Piano.width / 53,
                                e.preview2d.globalCompositeOperation = "destination-over";
                            if (Piano.colorMap[n]) {
                                var q = Piano.colorMap[n].hsl;
                                q && (e.preview2d.fillStyle = q,
    ...
    this.boot = function() {
        ...
        b.postview || (f = document.createElement("div"),
        ...
        g.setAttribute("style", "border-radius: 10px; position: absolute; top: 98px; width: " + canvas.bg.width + "px; height: 300px"),
...
(function(b) {
    ...
    b.trackNote = function(a, c, e) {
        ...
        "musicbox" === b.visualize && (e ? (a = MusicBox.scene.objects[c],
        a.scale.x = 1E3,
        MusicBox.render()) : (a = MusicBox.scene.objects[c],
        a.scale.x = 1,
        a.scale.y = 1))
    }
    ;
    ...
    b.chordOn = function(a) {
        "undefined" == typeof a && (a = b.key + 12 * b.octave);
        var c = clone(MusicTheory.Chords[b.chord]), e;
        for (e in c) {
            var d = a + c[e];
    ...
    b.chordOff = function(a) {
        var c = clone(MusicTheory.Chords[b.chord]), e = [], d;
        for (d in c)
            b.drawKeyLabel(a + c[d], !1),
            e.push(a + c[d] + MIDI.pianoKeyOffset);
...
(function() {
    ...
    b.renderScreen = function(a) {
        var e = Piano.height
          ...
          , m = k * e;
        0 === k % 2 ? (CanvasRender[0].style.top = -d + m + "px",
        CanvasRender[1].style.top = -d + e + m + "px") : (CanvasRender[1].style.top = -d + m + "px",
            ...
            for (var w = 0, F = 0; w < k.length; w++) {
                ...
                case "channel":
                    ...
                    case "noteOff":
                        ...
                        z = n >> 0,
                        d.fillRect(u, y, z, x),
                        d.strokeRect(u, y, z, x)) : (u = (z >> 0) + 0.5,
                        z = l >> 0,
...
Piano.drawKeyLabel = function(b, a) {
    if ((MIDI.Player.playing || "preview" !== Piano.visualize) && Piano.domKeys[b] && 0 <= b && 88 >= b)
        if (a) {
            ...
            e && -1 === e.className.indexOf("force") && (e.className += " force",
            e.style.color = "",
            e.style.textShadow = "",
            e.style.backgroundColor = c)
        } else
            (e = document.getElementById("note" + b)) && -1 !== e.className.indexOf("force") && (e.className = e.className.replace(" force", ""),
            e.style.background = "",
...
Piano.mouseStop = function(b, a) {
    var c = parseInt(a);
    b.shiftKey ? (Piano.clearNotes(),
    Piano.chordOff(c)) : Piano.noteOff(c)
}
;
...
Piano.mouseOver = function(b) {
    if (!1 != Piano.mouseIsActive)
        if ("undefined" == typeof this.name) {
            ...
            this.currentNote !== a && (this.currentNote = a,
            Piano.mouseStop(b, this.currentNote),
            Piano.mousePlay(a, b))
        } else
...
Piano.fileBrowserToggle = function() {
    ...
    0 !== parseInt(b.style.opacity) ? (b.style.opacity = 0,
    setTimeout(function() {
        b.style.display = "none"
    }, 500),
    Event.remove(document, "keydown", Piano.fileBrowserKeyboard)) : (b.style.display = "block",
    setTimeout(function() {
        b.style.opacity = 1
    }, 1),
...
Piano.fileBrowser = function() {
    ...
    Piano.fileBrowserUpdate = function(a) {
        ...
        var c = k.getElementsByTagName("div"), d = -1, e = !!c.length, n = 0, r;
        for (r in Piano.files) {
            d++;
            var q = r.replace(".mid", "")
              , p = a && 0 > r.toLowerCase().indexOf(a);
            e && (p ? c[d].style.display = "none" : (c[d].style.display = "block",
            n++,
            p = !0));
    ...
    e.onkeyup = e.onkeypress = e.onkeydown = function(a) {
        ...
        "keyup" === a.type && (window.clearTimeout(d),
...
(function() {
    ...
    var a, c, e, d, k = [], m = "#interactive" == window.location.hash, g;
    MusicBox.init = function() {
        ...
        f.position.normalize();
        MusicBox.scene.addLight(f);
        for (var f = 0, k = new THREE.CubeGeometry(100,40,40), g = 1; 9 > g; g++)
            for (var m = 0; 12 > m; m++) {
        ...
        for (i = 0; 4E3 > i; i++)
            vector = new THREE.Vector3(2E3 * Math.random() - 1E3,2E3 * Math.random() - 1E3,2E3 * Math.random() - 1E3),
            k.vertices.push(new THREE.Vertex(vector));
    ...
    MusicBox.render = function() {
        ...
        if (m) {
            ...
            0 < b.length ? g != b[0].object && (g && (g.scale.x = 1),
            g = b[0].object,
            g.currentHex = g.materials[0].color.hex,
            MIDI.noteOn && (b = Color.Space(g.currentHex, "HEX>RGB>HSL"),
            b = (12 * (b.H / 360) >> 0) + 12 * (b.L / 10 >> 0),
            g.scale.x = 100,
            MIDI.noteOn(1, b))) : (g && (g.scale.x = 1),
            g = null)
        }
        ...
        for (i = 0; i < k.length; i++)
            ...
            k[i].color.setHSV(h, color[1], color[2]);
...
(function(b) {
    b.enableConfigure = function(a) {
        ...
        a ? (Event.remove(window, "keydown", Piano.keyDown),
        Event.remove(window, "keyup", Piano.keyUp),
        b.display = "block") : (Event.add(window, "keydown", Piano.keyDown),
        Event.add(window, "keyup", Piano.keyUp),
        b.display = "none")
    }
    ;
    b.enableView = function(a) {
        "postview" === Piano.visualize ? (MIDI.UI.enableTheoryView(),
        a || Piano.func()) : MIDI.UI.enableSongView()
    }
    ;
    b.enableTheoryView = function() {
        Piano.setAnimation();
        change.className("view-theory", "selected");
        ...
        a = document.getElementById("theory"),
        a.style.display = "inline-block",
        a.loaded || (a.loaded = !0,
        b.drawKeySignatures(a),
        b.drawOctaves(a),
        b.drawChords(a),
        b.drawInversions(a),
        b.drawScales(a)),
        Piano.visualize = "postview",
        localStorage.setItem("visualize", Piano.visualize),
        Piano.Animation.boot())
    }
    ;
    b.enableSongView = function() {
        ...
        var a = document.getElementById("playback");
        "inline-block" !== a.style.display && (a.style.display = "inline-block",
        document.getElementById("theory").style.display = "none",
        Piano.visualize = "preview",
        localStorage.setItem("visualize", Piano.visualize),
        Piano.Animation.boot())
    }
    ;
    ...
    b.togglePlayer = function(a) {
        ...
        "true" === a ? (b.setAttribute("toggled", !1),
        b.src = "./media/pause.png",
        Piano.clearNotes(),
        c && (Piano.resume(),
        Piano.setAnimation())) : (b.setAttribute("toggled", !0),
        b.src = "./media/play.png",
        c && MIDI.Player.pause())
    }
    ;
    b.drawTimeWarp = function() {
        ...
        var c, e, g = document.createElement("input");
    ...
    b.drawSynesthesia = function() {
        var b = e({
            ...
            callback: function(a) {
                ...
                Piano.drawKeyboard();
                MIDI.Player.renderScreen();
                MIDI.Player.playing || (Piano.clearNotes(),
                Piano.func(),
                Piano.inversion = 0)
            },
            selected: Piano.HSL,
    ...
    b.drawInstruments = function() {
        ...
        for (m in MIDI.instruments) {
            ...
            g.instrument && (k != g.category && (k = g.category,
            c[k] = null),
            c[g.instrument] = m)
        }
        a("Instrument", e({
    ...
    var a = function(a, b, c) {
      ...
      , e = function(a) {
        ...
        for (e in a.arr)
            null === a.arr[e] ? (c = document.createElement("optgroup"),
            c.label = "-" + e.toUpperCase() + "-") : (c = document.createElement("option"),
            a.selected == e && (c.selected = !0),
            c.value = e,
            c.text = e),
            b.appendChild(c);
        return b
